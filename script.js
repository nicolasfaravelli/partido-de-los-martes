...
const ICON_SERIES = ["🔈", "🔉", "🔊"];
const GIF_ESCALA_X = "1.35";
const GIF_ESCALA_Y = "1.35";
const GIF_POS_X = "0px";   
const GIF_POS_Y = "0px";   
    ...
    if(cardCont) {
        ...
        const htmlStatsTop = `
            <div style="position:absolute; top:${posVBloquePrincipal}; left:0%; width:100%; display:flex; flex-direction:column; z-index:10; text-align:center;">                
                ...
                <div style="display:flex; justify-content:center; align-items:center; margin-bottom:${esp_Bajo_NumAsis}; position:relative; width:100%;">
